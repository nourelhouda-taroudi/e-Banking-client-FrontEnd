...
export class FactureService {
  ...
  public updateFacture(id_facture: Number): Observable<void> {
    return this.http.put<void>(`http://localhost:8090/client/facture/update/${id_facture}`, { headers: this.headers });
